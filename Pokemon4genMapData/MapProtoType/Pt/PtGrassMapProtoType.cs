...
{
    class PtGrassMapProtoType : PtMapProtoType<WrappedGrass>
    {
        ...
        protected override Slot[] BuildTable(DecodedDPtMapData<WrappedGrass> mapData, PtQueryArgs args)
        {
        ...
        public PtGrassMapProtoType(string mapData) : base(mapData, MapType.Grass) { }
        public PtGrassMapProtoType(string mapData, MapType type) : base(mapData, type) { }
    }
    ...
    class PtTrophyGardenProtoType : PtGrassMapProtoType
    {
        ...
        public PtTrophyGardenProtoType(string mapData) : base(mapData) { }
    }
